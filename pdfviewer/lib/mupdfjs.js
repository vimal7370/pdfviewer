...
export class PDFPage extends mupdf.PDFPage {
    ...
    applyRedactions(blackBoxes = true, imageMethod = PDFPage.REDACT_IMAGE_PIXELS, lineArtMethod = PDFPage.REDACT_LINE_ART_REMOVE_IF_COVERED, textMethod = PDFPage.REDACT_TEXT_REMOVE) {
        var num;
